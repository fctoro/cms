      ...
      <div className="space-y-5 sm:space-y-6">
        <ComponentCard title="Default Avatar">
          ...
          <div className="flex flex-col items-center justify-center gap-5 sm:flex-row">
            ...
            <Avatar src="/images/user/owner.jpg" size="small" />
            <Avatar src="/images/user/owner.jpg" size="medium" />
            <Avatar src="/images/user/owner.jpg" size="large" />
            <Avatar src="/images/user/owner.jpg" size="xlarge" />
            <Avatar src="/images/user/owner.jpg" size="xxlarge" />
          </div>
        </ComponentCard>
        ...
        <ComponentCard title="Avatar with busy indicator">
          <div className="flex flex-col items-center justify-center gap-5 sm:flex-row">
            <Avatar
              ...
              status="busy"
            />
            <Avatar src="/images/user/owner.jpg" size="small" status="busy" />
            <Avatar
              src="/images/user/owner.jpg"
              size="medium"
              status="busy"
            />
            <Avatar src="/images/user/owner.jpg" size="large" status="busy" />
            <Avatar
              src="/images/user/owner.jpg"
              size="xlarge"
              status="busy"
