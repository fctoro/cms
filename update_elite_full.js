...
const players = [
  { no: "1", nom: "Pierre", prenom: "Wendy", poste: "GK", club: "Fc Flambo", poids: "58KG", hauteur: "1M5", photo: "", video: "" },
  ...
  { no: "3", nom: "LAURE", prenom: "Angelo", poste: "Aillier Attaquant", club: "FC TORO", poids: "1M40", hauteur: "1M45", photo: "", video: "" },
...
async function run() {
  try {
    ...
    console.log("Elite database updated with media and 10 players.");
  } catch (err) {
    console.error(err);
  } finally {
    process.exit(0);
